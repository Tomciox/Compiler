...
/********************   Prog    ********************/
Prog::Prog(ListTopDef *p1) { listtopdef_ = p1; }
Prog::Prog(const Prog & other) {   listtopdef_ = other.listtopdef_->clone();
...
/********************   FnDef    ********************/
FnDef::FnDef(Type *p1, Ident p2, ListArg *p3, Block *p4) { type_ = p1; ident_ = p2; listarg_ = p3; block_ = p4; }
FnDef::FnDef(const FnDef & other) {   type_ = other.type_->clone();
  ident_ = other.ident_;
...
FnDef::~FnDef() { delete(type_); delete(listarg_); delete(block_); }

void FnDef::accept(Visitor *v) { v->visitFnDef(this); }
FnDef *FnDef::clone() const {
  return new FnDef(*this);
}

/********************   ListTopDef    ********************/
ListTopDef::ListTopDef(TopDef *p1, ListTopDef *p2) { topdef_ = p1; listtopdef_ = p2; }
ListTopDef::ListTopDef(const ListTopDef & other) {   topdef_ = other.topdef_->clone();
  listtopdef_ = other.listtopdef_->clone();

}
ListTopDef &ListTopDef::operator=(const ListTopDef & other) {
  ListTopDef tmp(other);
  swap(tmp);
  return *this;
}
void ListTopDef::swap(ListTopDef & other) {
  std::swap(topdef_, other.topdef_);
  std::swap(listtopdef_, other.listtopdef_);

}

ListTopDef::~ListTopDef() { delete(topdef_); delete(listtopdef_); }
ListTopDef::ListTopDef(TopDef *p)
{
  topdef_ = p;
  listtopdef_= 0;
}
ListTopDef* ListTopDef::reverse()
{
  if (listtopdef_ == 0) return this;
  else
  {
    ListTopDef *tmp = listtopdef_->reverse(this);
    listtopdef_ = 0;
    return tmp;
  }
}

ListTopDef* ListTopDef::reverse(ListTopDef* prev)
{
  if (listtopdef_ == 0)
  {
    listtopdef_ = prev;
...
void ListTopDef::accept(Visitor *v) { v->visitListTopDef(this); }
ListTopDef *ListTopDef::clone() const {
  return new ListTopDef(*this);
}

/********************   Ar    ********************/
Ar::Ar(Type *p1, Ident p2) { type_ = p1; ident_ = p2; }
Ar::Ar(const Ar & other) {   type_ = other.type_->clone();
  ident_ = other.ident_;
...
void Ar::accept(Visitor *v) { v->visitAr(this); }
Ar *Ar::clone() const {
  return new Ar(*this);
}

/********************   ListArg    ********************/
ListArg::ListArg(Arg *p1, ListArg *p2) { arg_ = p1; listarg_ = p2; }
ListArg::ListArg(const ListArg & other) {   arg_ = other.arg_->clone();
  listarg_ = other.listarg_->clone();

}
ListArg &ListArg::operator=(const ListArg & other) {
  ListArg tmp(other);
  swap(tmp);
  return *this;
}
void ListArg::swap(ListArg & other) {
  std::swap(arg_, other.arg_);
  std::swap(listarg_, other.listarg_);

}

ListArg::~ListArg() { delete(arg_); delete(listarg_); }
ListArg::ListArg(Arg *p)
{
  arg_ = p;
  listarg_= 0;
}
ListArg* ListArg::reverse()
{
  if (listarg_ == 0) return this;
  else
  {
    ListArg *tmp = listarg_->reverse(this);
    listarg_ = 0;
    return tmp;
  }
}

ListArg* ListArg::reverse(ListArg* prev)
{
  if (listarg_ == 0)
  {
    listarg_ = prev;
...
void ListArg::accept(Visitor *v) { v->visitListArg(this); }
ListArg *ListArg::clone() const {
  return new ListArg(*this);
}

/********************   Blk    ********************/
Blk::Blk(ListStmt *p1) { liststmt_ = p1; }
Blk::Blk(const Blk & other) {   liststmt_ = other.liststmt_->clone();
...
Blk::~Blk() { delete(liststmt_); }

void Blk::accept(Visitor *v) { v->visitBlk(this); }
Blk *Blk::clone() const {
  return new Blk(*this);
}

/********************   ListStmt    ********************/
ListStmt::ListStmt(Stmt *p1, ListStmt *p2) { stmt_ = p1; liststmt_ = p2; }
ListStmt::ListStmt(const ListStmt & other) {   stmt_ = other.stmt_->clone();
  liststmt_ = other.liststmt_->clone();

}
ListStmt &ListStmt::operator=(const ListStmt & other) {
  ListStmt tmp(other);
  swap(tmp);
  return *this;
}
void ListStmt::swap(ListStmt & other) {
  std::swap(stmt_, other.stmt_);
  std::swap(liststmt_, other.liststmt_);

}

ListStmt::~ListStmt() { delete(stmt_); delete(liststmt_); }
ListStmt::ListStmt(Stmt *p)
{
  stmt_ = p;
  liststmt_= 0;
}
ListStmt* ListStmt::reverse()
{
  if (liststmt_ == 0) return this;
  else
  {
...
ListStmt* ListStmt::reverse(ListStmt* prev)
{
  if (liststmt_ == 0)
  {
    liststmt_ = prev;
...
void ListStmt::accept(Visitor *v) { v->visitListStmt(this); }
...
void Empty::accept(Visitor *v) { v->visitEmpty(this); }
Empty *Empty::clone() const {
  return new Empty(*this);
}

/********************   BStmt    ********************/
BStmt::BStmt(Block *p1) { block_ = p1; }
BStmt::BStmt(const BStmt & other) {   block_ = other.block_->clone();
...
/********************   Decl    ********************/
Decl::Decl(Type *p1, ListItem *p2) { type_ = p1; listitem_ = p2; }
Decl::Decl(const Decl & other) {   type_ = other.type_->clone();
...
Decl::~Decl() { delete(type_); delete(listitem_); }
...
/********************   Ass    ********************/
Ass::Ass(Ident p1, Expr *p2) { ident_ = p1; expr_ = p2; }
Ass::Ass(const Ass & other) {   ident_ = other.ident_;
...
Ass::~Ass() { delete(expr_); }

void Ass::accept(Visitor *v) { v->visitAss(this); }
Ass *Ass::clone() const {
  return new Ass(*this);
}

/********************   Incr    ********************/
Incr::Incr(Ident p1) { ident_ = p1; }
Incr::Incr(const Incr & other) {   ident_ = other.ident_;
...
void Incr::accept(Visitor *v) { v->visitIncr(this); }
Incr *Incr::clone() const {
  return new Incr(*this);
}

/********************   Decr    ********************/
Decr::Decr(Ident p1) { ident_ = p1; }
Decr::Decr(const Decr & other) {   ident_ = other.ident_;
...
void Decr::accept(Visitor *v) { v->visitDecr(this); }
Decr *Decr::clone() const {
  return new Decr(*this);
}

/********************   Ret    ********************/
Ret::Ret(Expr *p1) { expr_ = p1; }
Ret::Ret(const Ret & other) {   expr_ = other.expr_->clone();
...
Ret::~Ret() { delete(expr_); }

void Ret::accept(Visitor *v) { v->visitRet(this); }
Ret *Ret::clone() const {
  return new Ret(*this);
}
...
void VRet::accept(Visitor *v) { v->visitVRet(this); }
VRet *VRet::clone() const {
  return new VRet(*this);
}

/********************   Cond    ********************/
Cond::Cond(Expr *p1, Stmt *p2) { expr_ = p1; stmt_ = p2; }
Cond::Cond(const Cond & other) {   expr_ = other.expr_->clone();
...
Cond::~Cond() { delete(expr_); delete(stmt_); }

void Cond::accept(Visitor *v) { v->visitCond(this); }
Cond *Cond::clone() const {
  return new Cond(*this);
}

/********************   CondElse    ********************/
CondElse::CondElse(Expr *p1, Stmt *p2, Stmt *p3) { expr_ = p1; stmt_1 = p2; stmt_2 = p3; }
CondElse::CondElse(const CondElse & other) {   expr_ = other.expr_->clone();
...
CondElse::~CondElse() { delete(expr_); delete(stmt_1); delete(stmt_2); }

void CondElse::accept(Visitor *v) { v->visitCondElse(this); }
CondElse *CondElse::clone() const {
  return new CondElse(*this);
}

/********************   While    ********************/
While::While(Expr *p1, Stmt *p2) { expr_ = p1; stmt_ = p2; }
While::While(const While & other) {   expr_ = other.expr_->clone();
  stmt_ = other.stmt_->clone();
...
While::~While() { delete(expr_); delete(stmt_); }
...
/********************   SExp    ********************/
SExp::SExp(Expr *p1) { expr_ = p1; }
SExp::SExp(const SExp & other) {   expr_ = other.expr_->clone();
...
/********************   NoInit    ********************/
NoInit::NoInit(Ident p1) { ident_ = p1; }
NoInit::NoInit(const NoInit & other) {   ident_ = other.ident_;
...
void NoInit::accept(Visitor *v) { v->visitNoInit(this); }
NoInit *NoInit::clone() const {
  return new NoInit(*this);
}

/********************   Init    ********************/
Init::Init(Ident p1, Expr *p2) { ident_ = p1; expr_ = p2; }
Init::Init(const Init & other) {   ident_ = other.ident_;
  expr_ = other.expr_->clone();
...
Init::~Init() { delete(expr_); }

void Init::accept(Visitor *v) { v->visitInit(this); }
Init *Init::clone() const {
  return new Init(*this);
}

/********************   ListItem    ********************/
ListItem::ListItem(Item *p1, ListItem *p2) { item_ = p1; listitem_ = p2; }
ListItem::ListItem(const ListItem & other) {   item_ = other.item_->clone();
  listitem_ = other.listitem_->clone();
...
void ListItem::swap(ListItem & other) {
  std::swap(item_, other.item_);
  std::swap(listitem_, other.listitem_);

}

ListItem::~ListItem() { delete(item_); delete(listitem_); }
ListItem::ListItem(Item *p)
{
  item_ = p;
  listitem_= 0;
}
...
{
  if (listitem_ == 0) return this;
  else
  {
    ListItem *tmp = listitem_->reverse(this);
    listitem_ = 0;
    return tmp;
  }
}

ListItem* ListItem::reverse(ListItem* prev)
{
  if (listitem_ == 0)
  {
    listitem_ = prev;
...
void ListItem::accept(Visitor *v) { v->visitListItem(this); }
...
void Str::accept(Visitor *v) { v->visitStr(this); }
Str *Str::clone() const {
  return new Str(*this);
}
...
void Bool::accept(Visitor *v) { v->visitBool(this); }
...
void Void::accept(Visitor *v) { v->visitVoid(this); }
Void *Void::clone() const {
  return new Void(*this);
}

/********************   Fun    ********************/
Fun::Fun(Type *p1, ListType *p2) { type_ = p1; listtype_ = p2; }
Fun::Fun(const Fun & other) {   type_ = other.type_->clone();
...
Fun::~Fun() { delete(type_); delete(listtype_); }

void Fun::accept(Visitor *v) { v->visitFun(this); }
Fun *Fun::clone() const {
  return new Fun(*this);
}
...
/********************   ELitInt    ********************/
ELitInt::ELitInt(Integer p1) { integer_ = p1; }
ELitInt::ELitInt(const ELitInt & other) {   integer_ = other.integer_;
...
void ELitInt::accept(Visitor *v) { v->visitELitInt(this); }
...
void ELitTrue::accept(Visitor *v) { v->visitELitTrue(this); }
...
void ELitFalse::accept(Visitor *v) { v->visitELitFalse(this); }
ELitFalse *ELitFalse::clone() const {
  return new ELitFalse(*this);
}

/********************   EApp    ********************/
EApp::EApp(Ident p1, ListExpr *p2) { ident_ = p1; listexpr_ = p2; }
EApp::EApp(const EApp & other) {   ident_ = other.ident_;
...
EApp::~EApp() { delete(listexpr_); }

void EApp::accept(Visitor *v) { v->visitEApp(this); }
...
/********************   Neg    ********************/
Neg::Neg(Expr *p1) { expr_ = p1; }
Neg::Neg(const Neg & other) {   expr_ = other.expr_->clone();
...
Neg::~Neg() { delete(expr_); }

void Neg::accept(Visitor *v) { v->visitNeg(this); }
Neg *Neg::clone() const {
  return new Neg(*this);
}

/********************   Not    ********************/
Not::Not(Expr *p1) { expr_ = p1; }
Not::Not(const Not & other) {   expr_ = other.expr_->clone();
...
/********************   EMul    ********************/
EMul::EMul(Expr *p1, MulOp *p2, Expr *p3) { expr_1 = p1; mulop_ = p2; expr_2 = p3; }
EMul::EMul(const EMul & other) {   expr_1 = other.expr_1->clone();
...
EMul::~EMul() { delete(expr_1); delete(mulop_); delete(expr_2); }
...
/********************   EAdd    ********************/
EAdd::EAdd(Expr *p1, AddOp *p2, Expr *p3) { expr_1 = p1; addop_ = p2; expr_2 = p3; }
EAdd::EAdd(const EAdd & other) {   expr_1 = other.expr_1->clone();
...
EAdd::~EAdd() { delete(expr_1); delete(addop_); delete(expr_2); }
...
/********************   ERel    ********************/
ERel::ERel(Expr *p1, RelOp *p2, Expr *p3) { expr_1 = p1; relop_ = p2; expr_2 = p3; }
ERel::ERel(const ERel & other) {   expr_1 = other.expr_1->clone();
...
ERel::~ERel() { delete(expr_1); delete(relop_); delete(expr_2); }

void ERel::accept(Visitor *v) { v->visitERel(this); }
ERel *ERel::clone() const {
  return new ERel(*this);
}

/********************   EAnd    ********************/
EAnd::EAnd(Expr *p1, Expr *p2) { expr_1 = p1; expr_2 = p2; }
EAnd::EAnd(const EAnd & other) {   expr_1 = other.expr_1->clone();
  expr_2 = other.expr_2->clone();
...
EAnd::~EAnd() { delete(expr_1); delete(expr_2); }
...
/********************   EOr    ********************/
EOr::EOr(Expr *p1, Expr *p2) { expr_1 = p1; expr_2 = p2; }
EOr::EOr(const EOr & other) {   expr_1 = other.expr_1->clone();
  expr_2 = other.expr_2->clone();
...
EOr::~EOr() { delete(expr_1); delete(expr_2); }
...
/********************   ListExpr    ********************/
ListExpr::ListExpr(Expr *p1, ListExpr *p2) { expr_ = p1; listexpr_ = p2; }
ListExpr::ListExpr(const ListExpr & other) {   expr_ = other.expr_->clone();
  listexpr_ = other.listexpr_->clone();
...
void ListExpr::swap(ListExpr & other) {
  std::swap(expr_, other.expr_);
  std::swap(listexpr_, other.listexpr_);

}

ListExpr::~ListExpr() { delete(expr_); delete(listexpr_); }
ListExpr::ListExpr(Expr *p)
{
  expr_ = p;
  listexpr_= 0;
}
ListExpr* ListExpr::reverse()
{
  if (listexpr_ == 0) return this;
  else
  {
    ListExpr *tmp = listexpr_->reverse(this);
    listexpr_ = 0;
    return tmp;
  }
}

ListExpr* ListExpr::reverse(ListExpr* prev)
{
  if (listexpr_ == 0)
  {
    listexpr_ = prev;
...
void ListExpr::accept(Visitor *v) { v->visitListExpr(this); }
...
void LTH::accept(Visitor *v) { v->visitLTH(this); }
LTH *LTH::clone() const {
  return new LTH(*this);
}
...
void LE::accept(Visitor *v) { v->visitLE(this); }
LE *LE::clone() const {
  return new LE(*this);
}
...
void GTH::accept(Visitor *v) { v->visitGTH(this); }
GTH *GTH::clone() const {
  return new GTH(*this);
}
...
void GE::accept(Visitor *v) { v->visitGE(this); }
GE *GE::clone() const {
  return new GE(*this);
}
...
void EQU::accept(Visitor *v) { v->visitEQU(this); }
EQU *EQU::clone() const {
  return new EQU(*this);
}
...
void NE::accept(Visitor *v) { v->visitNE(this); }
NE *NE::clone() const {
  return new NE(*this);
}
